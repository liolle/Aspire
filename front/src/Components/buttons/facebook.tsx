...
export function FacebookButton () {
    ...
    const connectlink = `https://www.facebook.com/v16.0/dialog/oauth?client_id=253355607076885&display=popup&response_type=token&redirect_uri=https://liolle.github.io/login&scope=email`
